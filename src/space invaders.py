...
def vytvor_kulicku():
    pozice_kulicky_x = pozicee_hlavne_x + velikostt_hlavne_x // 2 - polomer_kulicky
...
#design
    ...
    for kulicka_x, kulicka_y in kulicky:
        pygame.draw.ellipse(okno, (255, 0, 255), (kulicka_x, kulicka_y, polomer_kulicky * 2, polomer_kulicky * 2))
